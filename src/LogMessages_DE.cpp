...
const char lastTrackAlreadyActive[] = "Es wird bereits der letzte Titel gespielt.";
const char lastFolderAlreadyActive[] = "Es wird bereits der letzte Ordner gespielt.";
...
const char modeAllTrackAlphSortedRecursive[] = "Modus: Spiele alle Tracks (sortiert und rekursiv) des übergeordneten Ordners '%s'";
const char modeAllTrackRandomLoop[] = "Modus: Alle Tracks eines Ordners zufällig in Endlosschleife";
const char modeAudiobookRecursive[] = "Modus: Hörbuch rekursiv";
const char modeAllTrackRandomRecursive[] = "Modus: Spiele alle Tracks (zufällig sortiert und rekursiv) des übergeordneten Ordners '%s'";
...
const char wroteAtmoBrightnessToNvs[] = "Initiale Atmo-LED-Helligkeit wurde ins NVS geschrieben.";
const char restoredAtmoBrightnessForNmFromNvs[] = "Atmo-LED-Helligkeit für Nachtmodus wurde aus NVS geladen: %u";
...
const char playlistRecDepth[] = "Playlist-Generierung mit Rekursionstiefe: %u";
