...
#define __ESPUINO_SETTINGS_ESPA1S_H__
    ...
    */
    ...
    #define BUTTON_0                     99          // Button 0: GPIO to detect next
    #define BUTTON_1                 99          // Button 1: GPIO to detect previous
    #define BUTTON_2                36          // Button 2: GPIO to detect pause/play
