...
#define __ESPUINO_SETTINGS_CUSTOM_H__
   ...
   #define SD_MMC_1BIT_MODE
    ...
    // RFID (via I2C)
    #define RFID_IRQ                        21          // GPIO for IRQ
    #define RFID_RST                        19          // GPIO for Reset_O (19)
    #define I2C1_SDA                        23
    #define I2C1_SCL                        22
    ...
    #define NEXT_BUTTON                     34          // Button 0: GPIO to detect next
    #define PREVIOUS_BUTTON                 12          // Button 1: GPIO to detect previous (Important: as of 19.11.2020 changed from 33 to 2; make sure to change in SD-MMC-mode)
    ...
    // (optional) Monitoring of battery-voltage via ADC
        ...
        constexpr float referenceVoltage = 3.33;                  // Voltage between 3.3V and GND-pin at the develboard in battery-mode (disconnect USB!)
    ...
    // (optional) For measuring battery-voltage a voltage-divider is necessary. Their values need to be configured here.
        ...
        constexpr uint16_t rdiv2 = 90;                              // Rdiv2 of voltage-divider (kOhms) (measure exact value with multimeter!) => used to measure voltage via ADC!
    #endif
