...
#define __ESPUINO_SETTINGS_CUSTOM_H__
    ...
    */
    ...
    #define BUTTON_0                         4          // Button 0: GPIO to detect next
    #define BUTTON_1                         2          // Button 1: GPIO to detect previous (Important: as of 19.11.2020 changed from 33 to 2; make sure to change in SD-MMC-mode)
    #define BUTTON_2                         0          // Button 2: GPIO to detect pause/play
    #define BUTTON_3                        32          // (set to 99 to disable; 0->39 for GPIO; 100->115 for port-expander)
    ...
    #define WAKEUP_BUTTON                   BUTTON_3 // Defines the button that is used to wake up ESPuino from deepsleep.
