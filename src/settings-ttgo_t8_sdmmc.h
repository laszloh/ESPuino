...
#define RFID_CS                         19          // GPIO for chip select (RFID)
#define RFID_MOSI                       21          // GPIO for master out slave in (RFID)
#define RFID_MISO                       22          // GPIO for master in slave out (RFID)
#define RFID_SCK                        23          // GPIO for clock-signal (RFID)
#define RFID_IRQ                        35          // IRQ PIN
...
#define BUTTON_0                        34          // Button 0: GPIO to detect next
#define BUTTON_1                        36          // Button 1: GPIO to detect previous
#define BUTTON_2                        39          // Button 2: GPIO to detect pause/play
#define BUTTON_3                        99          // (set to 99 to disable; 0->39 for GPIO; 100->115 for port-expander)
...
#define WAKEUP_BUTTON                   BUTTON_2    // Defines the button that is used to wake up ESPuino from deepsleep.

// (optional) Power-control
#define POWER                            18         // GPIO used to drive transistor-circuit, that switches off peripheral devices while ESP32-deepsleep
#ifdef POWER
