// clang-format off
	...
	*/
	...
	Even if you don't use all of them, their numbers won't change
		...
		BUTTON_1: previous
		BUTTON_2: pause/play
		BUTTON_3: rotary-encoder push
		BUTTON_4: unassigned / optional
		BUTTON_5: unassigned / optional
	...
	Single-buttons [can be long or short] (examples):
		...
		BUTTON_3_SHORT => Button 3 (rotary-encoder) pressed shortly
		BUTTON_4_LONG  => Button 4 pressed long

	Multi-buttons [short only] (examples):
		BUTTON_MULTI_01 => Buttons 0+1 (next + previous) pressed in parallel
		BUTTON_MULTI_12 => Buttons 1+2 (previous + pause/play) pressed in parallel
