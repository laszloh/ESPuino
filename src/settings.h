    ...
    */
	...
	// (optinal) Neopixel
		...
		#define STATIC_LEDS				3				// Add static LEDs at the end of the Neopixel, for example to use for other artwork
		#define STATIC_LEDS_COLOR		{CRGB::Green, CRGB::Red, CRGB::Blue} // The color of the static leds
	#endif
