...
const char newLoudnessReceived[] = "Nouveau volume reçu : %u";
...
const char lastFolderAlreadyActive[] = "La dernière dossier est déjà en cours de lecture.";
...
const char modeAllTrackRandomRecursive[] = "Mode : toutes les pistes (par ordre aléatoire et récursif) du répertoire parent '%s'";
const char modeAllTrackAlphSortedLoop[] = "Mode : toutes les pistes (par ordre) du répertoire en boucle infinie";
const char modeAllTrackAlphSortedRecursive[] = "Mode : toutes les pistes (par ordre et récursif) du répertoire parent '%s'";
const char modeAllTrackRandomLoop[] = "Mode : toutes les pistes (par ordre aléatoire) du répertoire en boucle infinie";
const char modeAudiobookRecursive[] = "Modus: Livre audio récursive";
...
const char unableToCreateQueue[] = "Impossible de créer la file d'attente %s.";
...
const char wroteAtmoBrightnessToNvs[] = "Luminosité Atmo LED pour le mode nuit stockée dans NVS.";
const char restoredAtmoBrightnessForNmFromNvs[] = "Luminosité Atmo LED restaurée pour le mode nuit depuis NVS : %u";
...
const char playlistRecDepth[] = "Génération de la liste de lecture avec profondeur de récursion";
