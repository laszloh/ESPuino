...
#define BUTTON_1                        12          // Button 1: GPIO to detect previous (Important: as of 19.11.2020 changed from 33 to 2; make sure to change in SD-MMC-mode)
#define BUTTON_2                        32          // Button 2: GPIO to detect pause/play
