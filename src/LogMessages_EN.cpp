...
const char newLoudnessReceived[] = "New volume received: %u";
...
const char lastFolderAlreadyActive[] = "Already playing last track.";
...
const char modeAllTrackAlphSortedRecursive[] = "Mode: all tracks (in order and recursive) of parent directory '%s'";
const char modeAllTrackRandomLoop[] = "Mode: all tracks (in random order) of directory as infinite loop";
const char modeAudiobookRecursive[] = "Mode: Audiobook recursive";
const char modeAllTrackRandomRecursive[] = "Mode: all tracks (in random. order and recursive) of parent directory '%s";
...
const char unableToCreateQueue[] = "Unable to create queue %s.";
...
const char wroteAtmoBrightnessToNvs[] = "Stored Atmo LED-brightness for nightmode to NVS.";
const char restoredAtmoBrightnessForNmFromNvs[] = "Restored Atmo LED-brightness for nightmode from NVS: %u";
...
const char playlistRecDepth[] = "Playlist-generation with recursion depth";
...
const char secondsJumpBackward[] = "Jumped %d seconds backwards";
