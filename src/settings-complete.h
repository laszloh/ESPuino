// clang-format off
	...
	*/
	...
	// Rotary encoder
		...
		//#define REVERSE_ROTARY			// To reverse encoder's direction; switching CLK / DT in hardware does the same / also possible via webinterface
	...
	//#define GPIO_HP_EN                    112   	// To enable amp for headphones (GPIO or port-channel) => not available!
